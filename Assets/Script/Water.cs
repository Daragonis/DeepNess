...
public class Water : MonoBehaviour {
    ...
    public float[] WaterCoordinates = new float[4]; //Horizontal - Position-Scale / Vertical - Position-Scale

    

    void Start() {
        //Spawning our water
        SpawnWater(WaterCoordinates[0],WaterCoordinates[1],WaterCoordinates[2],WaterCoordinates[3]);
        //spawnwa
    }
